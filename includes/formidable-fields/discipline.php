...
/**
 * Custom Discipline Formidable field for AcademyXi.
 * 
 * @since 1.0.0
 */
class Field_Discipline
{
    /**
     * Field type
     *
     ...
     * @access private
     */
    protected const TYPE = 'axi_discipline';
    ...
    {
        $fields['axi_discipline'] = array(
            'name' => esc_html__( 'AXi Discipline', 'axi-system' ),
    ...
    function before_field_created( $field_values )
    {
        ...
        {
            $field_values['name'] = esc_html( 'Discipline', 'axi-system' );
        }
        return $field_values;
    }
    ...
    private function get_select_choices( $filtered = true )
    {
        ...
        if ( ! $filtered )
        {
            ...
            {
                $data[ $discipline->term_id ] = $discipline->name;
            }
        }
        else
        {
